//6b. Build a servlet program to create a cookie to get your name through text box and press submit button( through HTML)
//to display the message by greeting Welcome back your name ! , you have visited this page n times
